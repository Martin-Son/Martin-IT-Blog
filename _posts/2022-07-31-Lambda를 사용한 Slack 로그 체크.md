...
### Slack 백업 로그 체크
Slack에 RDS 스냅샷 로그를 저장하는 방법에 대해 이전 포스팅 [Lambda를 이용한 RDS 이벤트 로그 저장](https://martin-son.github.io/Martin-IT-Blog/aurora/mysql/rds/lambda/slack/2022/07/24/Lambda%EB%A5%BC-%EC%9D%B4%EC%9A%A9%ED%95%9C-RDS-%EC%9D%B4%EB%B2%A4%ED%8A%B8-%EB%A1%9C%EA%B7%B8-%EC%A0%80%EC%9E%A5.html)에서 정리했습니다.
단순히 백업 로그 저장하는 것 뿐만 아니라, 제대로 되고 있는지 체크가 필요한데 이번 포스팅에서는 해당 방법에 대해 정리해보겠습니다.

관련 람다를 구성하기에 앞서, 먼저 기존 Slack 채널에 접근하여, 저장된 백업 로그를 읽어 해당 결과를 Report 해줄 수 있는 **Slack Bot** 생성이 필요합니다.
Slack Bot은,  
